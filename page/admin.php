...
<body>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                <a href="detail.php?id=<?php echo $transaction['id']; ?>&jenis=<?php echo $transaction['jenis_transaksi']; ?>" class="btn btn-sm btn-info">
                                    <i class="fas fa-eye"></i>
                                </a>
                                    <button onclick="hapusTransaksi(<?php echo $transaction['id']; ?>, '<?php echo $transaction['jenis_transaksi']; ?>')" class="btn btn-sm btn-danger">
    ...
    <script>
    function hapusTransaksi(id, jenisTransaksi) {
        if(confirm('Apakah Anda yakin ingin menghapus transaksi ini?')) {
            fetch('proses_hapus_transaksi.php', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/x-www-form-urlencoded'
                },
                body: `id=${id}&jenis_transaksi=${jenisTransaksi}`
            })
